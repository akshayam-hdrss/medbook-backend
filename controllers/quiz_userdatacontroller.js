...
//       return res.status(400).json({ error: "userId, stageNumber and marks are required" });
//     }
...
// export const getAllStageData = async (req, res) => {
//   try {
...
// export const getUserStageData = async (req, res) => {
//   try {
...
// export const updateUserStageData = async (req, res) => {
//   try {
//     const { userId } = req.params;
...
//       return res.status(404).json({ message: "Stage data not found for this user" });
//     }
...
// export const deleteUserStageData = async (req, res) => {
//   try {
//     const { userId } = req.params;
...
//     if (result.affectedRows === 0) {
//       return res.status(404).json({ message: "No stage data found for this user" });
//     }
...
//     const totalStages = 6;
//     const remainingStages = Array.from({ length: totalStages }, (_, i) => i + 1)
